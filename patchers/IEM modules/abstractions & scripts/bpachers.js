// bpatchers.js
//
// automatically generate a bpatcher with bpatchers embedded in it.
// load abstractions into dynamically created bpatchers
// 
//
// dbw, 4.12
//
...
var numbpatchers = 0;
var vposition = new Array(128);

// Maxobj variables for scripting
var bpatchers = new Array(128);
var thescrollbars;
var thebpatcher;

// methods start here

// bpatcher -- generates and binds the sliders in the max patch
function bpatcher(val)
{
